        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"><h4 style="color:white; font-family:Brush Script MT,cursive; font-size:35px">maistore</h4></a>
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#" style="color:white"> maistore </a> </a> <span>Order Delivery &amp; Take-Out </span> </div>
