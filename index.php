...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <h4 style="color:white; font-family:Brush Script MT,cursive; font-size:35px">maistore</h4></a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Pastries<span class="sr-only"></span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/pastry.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h2 style="color:white;font-family: Georgia, serif;; font-size:50px">Springle with Sugar love</h2>
                    <h5 class="font-white space-xs">Find sweets, cutlets, and coupons for free</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to taste....</label>
                                <div class="form-group">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4 style="color:white;font-family: Georgia, serif;; font-size:20px"><span>1. </span>Choose Shop</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4 style="color:white;font-family: Georgia, serif;; font-size:20px"><span>2. </span>Order Sweets</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4 style="color:white;font-family: Georgia, serif;; font-size:20px"><span>3. </span>Delivery or take out</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Pastries of the Month</h2>
                    <p class="lead">The easiest way to your favourite sweet</p>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a tasty pastry</h3>
                                <p>We"ve got your covered with menus from over 345 delivery shops online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your pastry delivered! And enjoy your meal! Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured pastry shops</h4> </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Pastry Delivery App</h3>
                                <p>Now you can make sweets happen pretty much wherever you are thanks to the free easy-to-use Pastry Delivery &amp; Takeout App.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#" style="color:white"> maistore </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose pastry</a> </li>
                            <li><a href="#">Choose sweet</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Thirvalur</a> </li>
                            <li><a href="#">Tambaram</a> </li>
                            <li><a href="#">Guindy</a> </li>
                            <li><a href="#">Avadi</a> </li>
                            <li><a href="#">Poonamalle</a> </li>
                            <li><a href="#">Kundrathur</a> </li>
                            <li><a href="#">Koyambedu</a> </li>
                            <li><a href="#">Maduravoyal</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            ...
                            <p>Join the thousands of other shops who benefit from having their menus on TakeOff</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
